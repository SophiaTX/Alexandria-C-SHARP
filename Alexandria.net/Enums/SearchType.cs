...
namespace Alexandria.net.Enums
{
    ...
    public enum SearchType
    {
        ...
        /// </summary>
        [StringValue("by_sender_datetime")] BySenderDatetime = 2,

        /// <summary>
        /// Search by Receipient DateTime (UTC)
        /// </summary>
        [StringValue("by_recipient_datetime")] ByRecipientDatetime = 3,

        /// <summary>
        /// Search by buyer name
        /// </summary>
        [StringValue("by_buyer")] ByBuyer = 4,

        /// <summary>
        /// Search by App id
        /// </summary>
        [StringValue("by_app_id")] ByAppId = 5
    }
