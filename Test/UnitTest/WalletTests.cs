...
namespace UnitTest
{
    public class WalletTests : BaseTest
    {
        ...
        private readonly string _sign =
            "1f05e0a0ad257dd3f93fb01cacf8da5da2e1a632d6da4f1eb35506a3e5a854f8ff1ff42e725f0caac288226e29b7138bd02a3389b3fb4aab4b92cd9f3f0773e96";
        ...
        {
            var logging = new Logger(loggingType.server, "TestApp");
            const int itemCount = 30;
            for (var itemNumber = 0; itemNumber < itemCount; ++itemNumber)
                logging.WriteToLog($"this is an error message from the api message # {itemNumber} of {itemCount}", ErrorType.Warning);
            logging.Close();
        }
    }
}